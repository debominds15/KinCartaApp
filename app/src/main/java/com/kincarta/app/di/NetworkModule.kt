...
import com.kincarta.app.data.repository.CaseStudiesDetailsRepositoryImpl
...
import com.kincarta.app.util.Constants.BASE_URL
...
class NetworkModule {
    ...
    fun provideCaseStudyRepository(
        ...
        return CaseStudiesRepositoryImpl(database, retrofitService)
    }

    @Singleton
    @Provides
    fun provideCaseStudyDetailRepository(
        database: AppDatabase
    ): ICaseStudiesDetailsRepository {
        return CaseStudiesDetailsRepositoryImpl(database)
    }
}
